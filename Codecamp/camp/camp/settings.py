...
REGISTRATION_API_KEY = os.getenv(
...
INSTALLED_APPS = [
    ...
    'crispy_tailwind',
    'tailwind',
    'teencamp', # Custom app for Teen Camp
    'theme',  # Custom app for Tailwind theme
    'backoffice',  # Custom app for backoffice management
]
...
ASGI_APPLICATION = "camp.asgi.application"
